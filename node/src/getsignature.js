...
const getStub = getSignatureFunc()

function getSignature(room_id, user_id) {
    const a = `live_id=1,aid=6383,version_code=180800,webcast_sdk_version=1.0.12,room_id=${room_id},sub_room_id=,sub_channel_id=,did_rule=3,user_unique_id=${user_id},device_platform=web,device_type=,ac=,identity=audience`
    // const a = `live_id=1,aid=6383,version_code=180800,webcast_sdk_version=1.0.12,room_id=${room_id},sub_room_id=,sub_channel_id=,did_rule=3,user_unique_id=${user_id},device_platform=web,device_type=,ac=,identity=audience`
    console.log("aaaa:", a)
    const b = getStub(a)
    const stub = {
