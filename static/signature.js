...
window.getSign = function (t, n) {
    const e = {"X-MS-STUB": getSTUB(`live_id=1,aid=6383,version_code=180800,webcast_sdk_version=1.3.0,room_id=${t},sub_room_id=,sub_channel_id=,did_rule=3,user_unique_id=${n},device_platform=web,device_type=,ac=,identity=audience`)};
